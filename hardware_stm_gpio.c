...
#define GPIO_1_0TYPER_PP            0x00
#define GPIO_2_OTYPER               (uint32_t)(0x01<<2)
#define GPIO_2_0TYPER_PP            0x00
#define GPIO_3_OTYPER               (uint32_t)(0x01<<3)
#define GPIO_3_0TYPER_PP            0x00
#define GPIO_4_OTYPER               (uint32_t)(0x01<<4)
#define GPIO_4_0TYPER_PP            0x00
#define GPIO_5_OTYPER               (uint32_t)(0x01<<5)
#define GPIO_5_0TYPER_PP            0x00
#define GPIO_6_OTYPER               0x40
#define GPIO_6_OTYPER_PP            0x00
#define GPIO_7_0TYPER               (uint32_t)(0x01<<7)
#define GPIO_7_0TYPER_PP            0x00
...
#define GPIO_10_0TYPER              (uint32_t)(0x01<<10)
...
void setGPIOB0( void )
{
    ...
    *reg_pointer = *reg_pointer | 0b01; // Set to 1
}
void clearGPIOB0( void )
{
    uint32_t *reg_pointer;
    reg_pointer = (uint32_t *)PORTB_ODR_REGISTER; // Point to register
    *reg_pointer = *reg_pointer & (~(uint32_t)0b01); // Clear bit
}
